...
- 💡 **互動式自主續問提示** (新功能)：AI 在解說與圖表下方自動產生 3 ~ 4 個量身定制的自主續問按鈕（大師分析、歷年配息、最新季報、技術走勢），點擊即可無縫追問
- 🔍 **2MD 即時行情與財經數據自動注入** (新功能)：查詢股票與行情時自動結合 2MD 即時檢索，提供最新股價、漲跌動能、本益比、殖利率與產業焦點，LLM 不再只回單句空話
